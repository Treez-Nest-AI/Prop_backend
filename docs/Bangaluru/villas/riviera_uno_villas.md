```yaml
project_name: Riviera Uno
project_type: Villas
configuration: 4 BHK Luxury Villas
location: Soukya Road, Kacharakanahalli, Bangalore
zone: East Bangalore
...
## Overview
Riviera Uno is a low-density gated enclave designed for families who value space, privacy, and elegance. With expansive layouts, Vastu-compliant planning, and thoughtfully curated open spaces, the project delivers a serene, resort-inspired lifestyle. Its strategic Whitefield location ensures excellent connectivity to ITPL, Hope Farm Junction, major IT hubs, reputed schools, hospitals, and retail destinations, backed by Goyal Co | Hariyana Group’s 50+ years of trusted legacy.

## Floor Plans
Thoughtfully designed 4 BHK luxury villa floor plans featuring private open deck terraces, spacious living areas, and efficient layouts.
...
## Unit Details
- 4 BHK Luxury Villas: 3,450 to 3,490 sq. ft.
